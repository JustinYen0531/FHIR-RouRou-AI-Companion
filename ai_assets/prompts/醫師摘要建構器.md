...
請輸出固定 JSON：
{
  ...
  "phq9_severity_band":"...",
  "phq9_summary":"...",
  "phq9_answers":[{"item_code":"...","item_label":"...","score":0,"narrative":"..."}],
  "followup_needs":["..."],
  "safety_flags":["..."],
  "patient_tone":"...",
  "draft_summary":"..."
...
11. symptom_evidence_track 與 symptom_inference_track 要與 evidence 對應，不可把操作指令、快捷鍵、模式切換當成症狀來源。
12. phq9_assessment 是病人自評的正式背景，不要把它改寫成 HAM-D，但要把它和臨床摘要並列處理。
13. 若目前臨床對話內容偏少，但有完整 PHQ-9 自評，仍要產出可讀的醫師摘要，而不是直接判定資料不足。
目前 summary_draft_state：{{#conversation.summary_draft_state#}}
目前正式 HAM-D 草稿：{{#conversation.hamd_formal_assessment#}}
目前 PHQ-9 自評：{{#conversation.phq9_assessment#}}
目前症狀對接結果：{{#conversation.symptom_bridge_state#}}
