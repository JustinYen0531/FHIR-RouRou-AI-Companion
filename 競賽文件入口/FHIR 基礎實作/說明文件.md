...
協助憂鬱症病患於回診前整理情緒、功能影響與量表線索，並產出可供醫療端理解的結構化草稿。
...
- YouTube 介紹影片：https://youtu.be/xgSwaATVUeA

### 建議使用方式

- 想直接操作系統：打開線上 Demo
- 想先快速理解功能：先看 YouTube 介紹影片
- 想看程式與技術細節：再下載本 repository
...
- `app`：前端、Node 伺服器、FHIR 與 AI 引擎主程式
- `評審必看_系統說明與實作文件`：目前主要說明文件、系統亮點與測試紀錄
- `廢棄之Dify聊天流`：舊版 Dify chatflow 匯出檔，作為歷史資料保留
- `flowise`：過往 Flowise 相關資產與轉換資料
- `tools`：開發用工具腳本
